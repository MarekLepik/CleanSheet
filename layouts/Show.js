          ...
          <div className="row">
            ...
            <div className="seven wide column container center">
              <div className="ui">
                ...
                <h3 className="ui left aligned header">Title</h3>
              </div>
              <div className="ui">
                <h3 className="ui right floated header">{data.author}</h3>
                <h3 className="ui left aligned header">Author</h3>
              </div>
              <div className="ui">
                <h3 className="ui right floated header">{data.description}</h3>
                <h3 className="ui left aligned header">Description</h3>
              </div>
              <div className="ui">
                <h3 className="ui right floated header">{data.homepage}</h3>
                <h3 className="ui left aligned header">Homepage</h3>
              </div>
              <div className="ui">
                <h3 className="ui right floated header">
                  {data.lockableContent}
                </h3>
                <h3 className="ui left aligned header">Lockable content</h3>
              </div>
